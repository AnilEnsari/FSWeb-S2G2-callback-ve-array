...
const yil14 = fifaData.filter((yil) => {
  return yil.Year === 2014;
});
const final14 = yil14.filter((finalStage) => finalStage.Stage === "Final");
...
function Finaller(fifaDizisi) {
  let finalGames = fifaDizisi.filter((x) => x.Stage === "Final");
  return finalGames;
  /* kodlar buraya */
}
